 ...
 */
package org.cmdbuild.service.rest.v3.openapi.config;
...
@OpenAPIDefinition(
        ...
        servers = { @Server(
                url = "{protocolType}://{host}:{port}/{basePath}/services/rest/v3",
                description = "CMDBuild rest v3 API base path",
                variables = {
                        @ServerVariable(
                                name = "protocolType",
        ...
        public Set<Object> getSingletons() {
                ...
                SwaggerConfiguration oasConfig = new SwaggerConfiguration()
                        ...
                        .resourcePackages(Set.of(
                                "org.cmdbuild.service.rest.v3.openapi.config",
                                "org.cmdbuild.service.rest.v3.endpoint"
                        ));
