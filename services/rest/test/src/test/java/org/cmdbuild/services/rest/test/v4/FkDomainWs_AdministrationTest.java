 ...
 * @author ldare
 */
public class FkDomainWs_AdministrationTest extends WsTestBase {

    private final FkDomainWs_Administration instance;

    private final List<String> A_KNOWN_ID_LIST;

    public FkDomainWs_AdministrationTest() {
        FkDomainWsCommand command = new FkDomainWsCommand(fkDomainRepository, daoService);
        instance = new FkDomainWs_Administration(userClassService, objectTranslationService, command);
