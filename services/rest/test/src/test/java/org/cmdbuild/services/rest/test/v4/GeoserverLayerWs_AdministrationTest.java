 ...
 * @author ldare
 */
public class GeoserverLayerWs_AdministrationTest extends WsTestBase {

    private final GeoserverLayerWs_Administration instance;
    ...
    public void testUpdate() {
        ...
        //arrange:
        when(gisService.getGeoserverLayerByCodeOrNull(A_KNOWN_CLASS_ID, A_KNOWN_ATTR_NAME1, A_KNOWN_CARD_ID1)).thenReturn(geoserverLayer);
        when(gisService.setGeoserverLayer(A_KNOWN_CLASS_ID, A_KNOWN_ATTR_NAME1, A_KNOWN_CARD_ID1, dataHandler)).thenReturn(geoserverLayer);
        ...
        //assert:
        verify(gisService).getGeoserverLayerByCodeOrNull(A_KNOWN_CLASS_ID, A_KNOWN_ATTR_NAME1, A_KNOWN_CARD_ID1);
        verify(gisService).setGeoserverLayer(A_KNOWN_CLASS_ID, A_KNOWN_ATTR_NAME1, A_KNOWN_CARD_ID1, dataHandler);
