...
@Tags({
        @Tag(name = "Email Templates", description = "APIs to manage email templates."),
        @Tag(name = "Administration")
})
@Consumes(APPLICATION_JSON)
@Produces(APPLICATION_JSON)
@Component
public class EmailTemplateWs_Administration {
    ...
    public EmailTemplateWs_Administration(EmailTemplateService emailTemplateService, EmailTemplateSerializationHelper emailTemplateSerializationHelper, EmailTemplateWsCommand command) {
    ...
    @Operation(
            ...
            parameters = {
                    ...
                    @Parameter(name = "includeBindings", in = ParameterIn.QUERY, description = "Include or not bindings in the response", schema = @Schema(type = "boolean"))
            },
            responses = {
    ...
    public Object readAllForClass(
        ...
        List<EmailTemplate> emailTemplateList = command.doReadAllForClass(emailTemplateService::getAll, filterStr, sort, classId);
    ...
    @Operation(
            ...
            parameters = {
                    ...
                    @Parameter(name = "includeBindings", description = "Include or not bindings in the response", schema = @Schema(type = "boolean"))
            },
            responses = {
                    @ApiResponse(responseCode = "200", description = "Successful retrieval of email templates"),
                    @ApiResponse(responseCode = "500", description = "Internal server error")
    ...
    public Object readAll(
        ...
        List<EmailTemplate> emailTemplateList = command.doReadAll(emailTemplateService::getAll, filterStr, sort);
        return response(paged(emailTemplateList.stream().map(c -> emailTemplateSerializationHelper.serializeTemplate(c, detailed, includeBindings)).collect(toList()), offset, limit));
    }
    ...
    @Operation(
            ...
            parameters = {
                    @Parameter(name = "templateId", description = "Id of the template", schema = @Schema(type = "string")),
                    @Parameter(name = "includeBindings", description = "Include or not bindings in the response", schema = @Schema(type = "boolean"))
            },
            responses = {
    ...
    public Object read(
        ...
        return response(emailTemplateSerializationHelper.serializeTemplate(emailTemplateService.getByNameOrId(id), true, includeBindings));
    }
    ...
    @Operation(
            ...
            requestBody = @RequestBody(content = @Content(schema = @Schema(implementation = WsEmailTemplateData.class))),
            responses = {
    ...
    public Object create(
        ...
        return response(emailTemplateSerializationHelper.serializeDetailedTemplate(emailTemplateService.createEmailTemplate(command.skipBatchReports(data.toEmailTemplate().build()))));
    }
    ...
    public Object update(
        ...
        return response(emailTemplateSerializationHelper.serializeDetailedTemplate(emailTemplateService.updateEmailTemplate(data.toEmailTemplate().withId(templateId).build())));
    }
