 ...
 * @author ldare
 */
@Path("administration/etl/templates/")
@Tags({
        @Tag( name = "ETL Templates", description = "APIs to manage ETL templates." ),
        @Tag( name = "Administration" )
})
@Consumes(APPLICATION_JSON)
@Produces(APPLICATION_JSON)
@Component
public class EtlTemplateWs_Administration {

    private final TempService tempService;
    private final CardWsSerializationHelperv3 cardWsSerializationHelperv3;
    private final EtlTemplateWsCommand command;

    public EtlTemplateWs_Administration(TempService tempService, CardWsSerializationHelperv3 cardWsSerializationHelperv3, EtlTemplateWsCommand command) {
    ...
    @Operation(
            ...
            description = "Get all ETL templates",
    ...
    public Object readAll(
        ...
        List<EtlTemplate> etlTemplateList = command.doReadAll(Predicates.alwaysTrue());
    ...
    @Operation(
            summary = "Get all ETL templates for a class",
            description = "Get all ETL templates for a class",
            parameters = {
                    @Parameter(name = CLASS_ID, in = ParameterIn.PATH, description = "Name of the class to query"),
                    @Parameter(name = "include_related_domains", in = ParameterIn.QUERY, description = "Include related domains")
            },
            requestBody = @RequestBody(content = @Content(schema = @Schema(implementation = WsQueryOptions.class))),
            responses = {
    ...
    public Object readAllForClass(
        ...
        List<EtlTemplate> etlTemplateList = command.doReadAllForClass(classId, includeRelatedDomains, Predicates.alwaysTrue());
    ...
    @Operation(
            summary = "Get all ETL templates for a process",
            description = "Get all ETL templates for a process",
            parameters = {
                    @Parameter(name = CLASS_ID, in = ParameterIn.PATH, description = "Name of the class to query"),
                    @Parameter(name = "include_related_domains", in = ParameterIn.QUERY, description = "Include related domains")
            },
    ...
    public Object readAllForProcess(
        ...
        List<EtlTemplate> etlTemplateList = command.doReadAllForProcess(classId, includeRelatedDomains, Predicates.alwaysTrue());
    ...
    @Path("by-view/{viewId}")
    @Operation(
            summary = "Get all ETL templates for a view",
            description = "Get all ETL templates for a view",
            parameters = {
    ...
    public Object readAllForView(
            @PathParam("viewId") String viewId, WsQueryOptions wsQueryOptions
    ) {
        List<EtlTemplate> etlTemplateList = command.doReadAllForView(viewId, Predicates.alwaysTrue());
    ...
    @Path("{templateId}/")
    @Operation(
            summary = "Get an ETL template by id or code",
            description = "Obtain details of a specific ETL template",
            parameters = {
                    @Parameter(name = "templateId", in = ParameterIn.PATH, description = "ID or code of the ETL template to query")
            },
            responses = {
                    @ApiResponse(responseCode = "200", description = "Successful retrieval of ETL template data") ,
                    @ApiResponse(responseCode = "404", description = "ETL template not found") ,
                    @ApiResponse(responseCode = "500", description = "Internal server error")
            },
            security = { @SecurityRequirement( name = "BasicAuth", scopes = {} ), @SecurityRequirement( name = "BearerAuth", scopes = {})}
    )
    ...
    @Operation(
            summary = "Export ETL template data",
            description = "Export ETL template data",
            parameters = {
                    @Parameter(name = "templateId", in = ParameterIn.PATH, description = "ID or code of the ETL template to query"),
                    @Parameter( name = FILTER, in = ParameterIn.QUERY, description = "Filter to apply to the export")
            },
            responses = {
                    @ApiResponse(responseCode = "200", description = "Successful export of ETL template} data"),
                    @ApiResponse(responseCode = "404", description = "ETL template not found"),
                    @ApiResponse(responseCode = "500", description = "Internal server error")
            },
            security = { @SecurityRequirement( name = "BasicAuth", scopes = {} ), @SecurityRequirement( name = "BearerAuth", scopes = {})}
    ...
    @Operation(
            summary = "Import data using ETL template",
            description = "Import data using ETL template",
            parameters = {
                    @Parameter(name = "templateId", in = ParameterIn.PATH, description = "ID or code of the ETL template to query"),
                    @Parameter(name = "detailed_report", in = ParameterIn.QUERY, description = "Include detailed report in the response")
            },
            requestBody = @RequestBody(content = @Content(schema = @Schema(implementation = DataHandler.class))),
            responses = {
                    @ApiResponse(responseCode = "200", description = "Successful import of data using ETL template"),
                    @ApiResponse(responseCode = "404", description = "ETL template not found"),
                    @ApiResponse(responseCode = "500", description = "Internal server error")
            },
            security = { @SecurityRequirement( name = "BasicAuth", scopes = {} ), @SecurityRequirement( name = "BearerAuth", scopes = {})}
    ...
    @Operation(
            summary = "Export data using inline ETL template",
            description = "Export data using inline ETL template",
            requestBody = @RequestBody(content = @Content(schema = @Schema(implementation = WsEtlTemplateData.class))),
            responses = {
                    @ApiResponse(responseCode = "200", description = "Successful export of data using inline ETL template"),
                    @ApiResponse(responseCode = "500", description = "Internal server error")
            },
            security = { @SecurityRequirement( name = "BasicAuth", scopes = {} ), @SecurityRequirement( name = "BearerAuth", scopes = {})}
    )
    ...
    @Path("inline/import")
    @Operation(
            summary = "Import data using inline ETL template",
            description = "Import data using inline ETL template",
            requestBody = @RequestBody(content = @Content(schema = @Schema(implementation = WsEtlTemplateData.class))),
            responses = {
                    @ApiResponse(responseCode = "200", description = "Successful import of data using inline ETL template") ,
                    @ApiResponse(responseCode = "500", description = "Internal server error")
            },
            security = { @SecurityRequirement( name = "BasicAuth", scopes = {} ), @SecurityRequirement( name = "BearerAuth", scopes = {})}
    )
    ...
    @Operation(
            ...
            description = "Create a new ETL template",
            requestBody = @RequestBody(content = @Content(schema = @Schema(implementation = WsEtlTemplateData.class))),
            responses = {
                    @ApiResponse(responseCode = "200", description = "Successful creation of ETL template") ,
                    @ApiResponse(responseCode = "500", description = "Internal server error")
            },
            security = { @SecurityRequirement( name = "BasicAuth", scopes = {} ), @SecurityRequirement( name = "BearerAuth", scopes = {})}
    )
    ...
    public Object create(
            @Parameter(schema = @Schema(implementation = WsEtlTemplateData.class))WsEtlTemplateData data
    ) {
        EtlTemplate etlTemplate = command.doCreate(data);
        return response(serializeDetailedTemplate(etlTemplate));
    }

    @PUT
    @Path("{templateId}/")
    @Operation(
            summary = "Update an existing ETL template",
            description = "Update an existing ETL template",
            parameters = {
                    @Parameter(name = "templateId", in = ParameterIn.PATH, description = "ID of the ETL template to update")
            },
            requestBody = @RequestBody(content = @Content(schema = @Schema(implementation = WsEtlTemplateData.class))),
            responses = {
                    @ApiResponse(responseCode = "200", description = "Successful update of ETL template"),
                    @ApiResponse(responseCode = "500", description = "Internal server error")
            },
            security = { @SecurityRequirement( name = "BasicAuth", scopes = {} ), @SecurityRequirement( name = "BearerAuth", scopes = {})}
    )
    ...
    public Object update(
        ...
        EtlTemplate etlTemplate = command.doUpdate(templateId, data);
        return response(serializeDetailedTemplate(etlTemplate));
    }
    ...
    @Operation(
            ...
            description = "Delete a specific ETL template",
            parameters = {
                    @Parameter(name = "templateId", in = ParameterIn.PATH, description = "ID of the ETL template to delete")
            },
            responses = {
                    @ApiResponse( responseCode = "200", description = "Successful deletion of ETL template"),
