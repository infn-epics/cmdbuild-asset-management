 ...
 * @author schursin
 */
@Path("administration/{" + TYPE + ":classes|processes}/{" + CLASS_ID + "}/domains")
@Tags({
        @Tag(name = "Class or process domains", description = "APIs to manage domains for classes and processes."),
        @Tag(name = "Administration")
})
@Produces(APPLICATION_JSON)
@Component
public class ClassOrProcessDomainsWs_Administration {
    ...
    public ClassOrProcessDomainsWs_Administration(UserClassService userClassService, UserDomainService userDomainService, DomainSerializationHelper domainSerializationHelper, ClassOrProcessDomainsWsCommand command) {
    ...
    public Object getDomains(
            @PathParam(CLASS_ID) @Parameter(description = "IName of the class to query") String classId,
        ...
        List<Domain> listDomain = command.doGetDomains(classId, userDomainService::getUserDomainsForClasse);
