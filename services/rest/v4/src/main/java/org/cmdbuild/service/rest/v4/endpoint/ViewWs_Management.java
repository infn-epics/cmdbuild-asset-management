...
@Component
public class ViewWs_Management {
    ...
    @Operation(
            ...
            parameters = {
                    ...
                    @Parameter(name = "shared", in = ParameterIn.QUERY, description = "Only Shared (true) or all views", schema = @Schema(type = "boolean"))
            },
            responses = {
    ...
    public Object getMany(
        ...
        List<View> views = command.doGetMany(viewService::getActiveViewsForCurrentUser);
    ...
    @Operation(
            ...
            description = "Obtain a specific view",
            parameters = {
                    @Parameter(name = "viewId", in = ParameterIn.PATH, description = "Id of the view to query", schema = @Schema(type = "string"))
            },
            responses = {
    ...
    public Object getOne(
        ...
        View view = command.doGetOne(viewId, viewService::getForCurrentUserByNameOrId);
    ...
    @Operation(
            ...
            description = "Obtain attributes for a specific view",
            parameters = {
                    @Parameter(name = "viewId", in = ParameterIn.PATH, description = "Id of the view to query", schema = @Schema(type = "string"))
            },
            responses = {
    ...
    public Object getAttributes(
        ...
        Collection<Attribute> attributesForView = command.doGetAttributes(viewId, viewService::getForCurrentUserByNameOrId);
    ...
    @Operation(
            ...
            requestBody = @RequestBody(content = @Content(schema = @Schema(implementation = WsViewData.class)), description = "View data"),
            responses = {
    ...
    @Operation(
            ...
            parameters = {
                    @Parameter(name = "viewId", in = ParameterIn.PATH, description = "Id of the view to update", schema = @Schema(type = "string"))
            },
            requestBody = @RequestBody(content = @Content(schema = @Schema(implementation = WsViewData.class)), description = "View data"),
            responses = {
    ...
    @Operation(
            ...
            parameters = {
                    @Parameter(name = "viewId", in = ParameterIn.PATH, description = "Id of the view to delete", schema = @Schema(type = "string"))
            },
            responses = {
    ...
    public Object delete(
        ...
        command.doDelete(viewId, viewService::getForCurrentUserByNameOrId);
        return success();
    }
    ...
    @Operation(
            summary = "Print a view report",
            description = "Generate and download a report for a specific view",
            parameters = {
                    @Parameter(name = "viewId", in = ParameterIn.PATH, description = "Id of the view to query", schema = @Schema(type = "string")),
                    @Parameter(name = FILTER, in = ParameterIn.QUERY, description = "Filter to apply to the view", schema = @Schema(type = "string")),
                    @Parameter(name = SORT, in = ParameterIn.QUERY, description = "How to order results", schema = @Schema(ref = "DefaultSortExample")),
                    @Parameter(name = LIMIT, in = ParameterIn.QUERY, description = "Number of items to return in the response", schema = @Schema(ref = "DefaultLimitExample")),
                    @Parameter(name = START, in = ParameterIn.QUERY, description = "A long value to set an offset in the resultset", schema = @Schema(minimum = "0"), example = "0"),
                    @Parameter(name = EXTENSION, in = ParameterIn.QUERY, description = "Extension of the report to generate", schema = @Schema(type = "string")),
                    @Parameter(name = "attributes", in = ParameterIn.QUERY, description = "Attributes to include in the report", schema = @Schema(type = "string"))
            },
            responses = {
                    @ApiResponse(responseCode = "200", description = "Successful generation of view report"),
                    @ApiResponse(responseCode = "404", description = "The view was not found"),
                    @ApiResponse(responseCode = "500", description = "Internal server error")
            },
            security = { @SecurityRequirement( name = "BasicAuth", scopes = {} ), @SecurityRequirement( name = "BearerAuth", scopes = {})}
