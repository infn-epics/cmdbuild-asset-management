...
public class DashboardUtils {
    ...
    public static List<String> getCqlExprsInOrder(DashboardData dashboard) { //note: this MUST match the order in dashboard serialization (DashboardWs) for ecql filter processing !!
