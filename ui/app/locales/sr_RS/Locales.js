(function () {
    Ext.define('CMDBuildUI.locales.sr_RS.Locales', {
        ...
        arialabels: {
            buttonplaceholder: 'Дугме',
            iframeplaceholder: 'Едиитор текста',
            languageselector: 'Избор језика',
            resizepanel: {
                horizontally: 'Промени ширину панела',
                vertically: 'Промени висину панела'
            },
        ...
        calendar: {
            ...
            waiteventgeneration: 'Догађаји се генеришу, молимо сачекајте да се процес заврши',
        ...
        common: {
            actions: {
                ...
                close: 'Затвори',
                copy: 'Копирај',
                copyerrormessage: 'Копирај поруку о грешци',
                delete: 'Уклони',
                edit: 'Измени',
                execute: 'Изврши',
                forward: 'Проследи',
        ...
        dashboards: {
            tools: {
                ...
                downloaddata: 'Преузми податке са графикона',
        ...
        errors: {
            ...
            nodatatoexport: 'Графикон нема податке за извоз',
        ...
        gis: {
            ...
            code: 'Код',
            contextmenu: {
                coordinates: 'Очитај координате',
                coordinatescopiedmessage: 'Координате су копиране'
            },
            description: 'Опис',
            extension: {
                errorCall: 'Грешка',
        ...
        importexport: {
            ...
            gis: {
                importconfiguration: 'Увези конфигурацију',
                shapeimportdisabled: 'Увоз облика није омогућен за овај образац',
                shapeimportenabled: 'За овај образац је омогућен увоз облика'
            },
            ifc: {
                card: 'Картица',
                project: 'Пројекат',
        ...
        joinviews: {
            ...
            selectdisplayattributegrid:
                'Молимо - изаберите бар један атрибут који ће бити приказан у табели и један који ће бити приказиван у редукованој табели',
        ...
        main: {
            ...
            mobilediff: {
                acceptall: 'Прихвати све измене',
                acceptclass: 'Прихвати свих {0} измена',
                acceptsingle: 'Прихвати измену',
                attribute: 'Атрибут',
                changedcards: 'Измењене картице ({0})',
                confirmedit: 'Вршите измену на {0} картица. Да ли сте сигурни да желите да наставите?',
                createdcards: 'Креиране картице ({0})',
                current: 'Тренутна вредност',
                diffempty: 'Нема измена за евалуацију',
                incoming: 'Нова вредност',
                popuptitle: 'Примени измене на скупу података {0}',
                rejectall: 'Одбаци све измене',
                rejectclass: 'Одбаци свих {0} измена',
                rejectsingle: 'Одбаци измену',
                removedcards: 'Уклоњеих картица ({0})'
            },
            ...
            preferences: {
                ...
                notificationssoundvolume: 'Јачина звука нотификациија',
                period: 'Тачка',
        ...
        notifier: {
            attention: 'Пажња',
            copied: 'Копирано',
            copied_to_the_clipboard: 'Текст копиран',
            error: 'Грешка',
            genericerror: 'Генеричка грешка',
            genericerrormessage: 'За више информација, проверите системске логове',
        ...
        relations: {
            ...
            cardnotpresentmessage:
                'Повезана картица није више доступна. Да би наставили са изменама неопходно је да изаберете другу картицу.',
            code: 'Код',
        ...
        widgets: {
            attachment: {
                ...
                saveprocessmessage:
                    'Прилози могу бити снимљени само на постојеће картице. Уколико потврдите снимање, креираће се инстанца процеса са подацима из форме.'
            },
            calendar: {
