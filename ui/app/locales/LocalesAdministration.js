    ...
    administration: {
        attributes: {
            ...
            fieldlabels: {
                ...
                anonymizable: 'Anonymize on dump',
                attributegroups: 'Attribute groupings',
                ...
                group: 'Group',
                help: 'Help',
                helpalwaysvisible: 'Always visible',
                hideinfilter: 'Hide in filter',
                hideingrid: 'Exclude from grid',
                ...
                sortingenabled: 'Enable sorting',
                synctodmsattr: 'Syncronize to DMS attribute',
                textcontentsecurity: 'Content Security',
                thousandsseparator: 'Thousands separator',
                trimenabled: 'Trim on save',
                unique: 'Unique',
                unitofmeasure: 'Unit of measure',
                unitofmeasurelocation: 'Positioning of the UM',
            ...
            strings: {
                ...
                formulawarningmessage:
                    'If the attribute is not excluded from the grid, data loading may take a long time.',
                hidden: 'Hidden',
                htmlall: 'HTML all',
                htmlsafe: 'HTML safe',
                immutable: 'Immutable',
                ...
                readonly: 'Read only',
                removegridorders:
                    'In order to reorder the attributes, the current sorting must be removed. Do you want to proceed?',
                rfid: 'RFID',
                scalemustbesmallerthanprecision: 'Scale must be smaller than Precision',
                thefieldcantbecheckedifcheckedexcludefromgrid:
                    'This field can\'t be checked if the field "Exclude from grid" is checked',
                thefieldexcludefromgridcantbechecked:
                    'This field can\'t be checked if the fields "Show in grid" or "Show in reduced grid" are checked',
        ...
        classes: {
            fieldlabels: {
                ...
                barcodesearchattr: 'Barcode/RFID search attribute',
        ...
        common: {
            ...
            labels: {
                ...
                contextmenuitems: 'Contextual menu',
                default: 'Default',
            ...
            messages: {
                ...
                areyousureredirectplugin:
                    'The changes will be saved, and you will be redirected to the plugin configuration page. Are you sure you want to proceed?',
                ...
                cannotsortitems:
                    'You can not reorder the items if some filters are present or the inherited attributes are hidden. Please remove them and try again.',
        ...
        datasets: {
            ...
            adddatasetpopup: 'Add dataset {0}',
            datasetlocked: 'This dataset is currently locked and cannot be modified.',
            deleteviewconfirm: 'Are you sure that you want to delete this dataset?',
            deselectattribute: 'The {0} attribute cannot be deselected',
            deselectmandatoryattribute:
                'The {0} attribute cannot be deselected or changed because it is mandatory and the class is writable',
            deselectmandatoryattributes:
                'The {0} attributes cannot be deselected or changed because they are mandatory and the class is writable',
            dynamicfilter: 'Dynamic filter',
            editdataset: 'Edit dataset {0}',
            emptydomain: 'There are no domains available for this class',
            klass: 'Class',
            mandatoryobjectmessage: 'At least one object should be checked',
            objectschoice: 'Select classes / processes / views',
            selectatleastoneattribute: 'Please select at least one attribute',
            viewdataset: 'View dataset {0}'
        },
        dmscategories: {
            adddmscategory: 'Add DMS category',
            allowfiletypesemptyvalue:
                'Enter extensions separated by comma. Eg pdf,odt,doc. Leave this field empty to use the DMS model setting as default.',
        ...
        dmsmodels: {
            ...
            allowedfiletypesemptyvalue:
                'Enter extensions separated by comma. Eg pdf,odt,doc. Leave this field empty to use system config setting as default.',
        ...
        domains: {
            ...
            fieldlabels: {
                ...
                cascadeactiondirect: 'On origin card delete',
                cascadeactioninverse: 'On destination card delete',
                descriptiondirect: 'Direct description',
                descriptioninverse: 'Inverse description',
                descriptionmasterdetail: 'Label master detail',
                destination: 'Destination',
                destinationdefaultclosed: 'Closed inline relation on destination',
                destinationinline: 'Inline relation on destination',
                enabled: 'Enabled',
                filtermasterdetail: 'Master detail CQL view filter',
                ismasterdetail: 'Master detail',
                labelmasterdetail: 'Label M/D',
                link: 'Link',
                masterdetailshort: 'M/D',
                source: 'Origin',
                sourcedefaultclosed: 'Closed inline relation on origin',
                sourceeditable: 'Origin editable',
                sourcefilter: 'Add/edit filter on origin',
                sourceinline: 'Inline relation on origin',
                targeteditable: 'Destination editable',
                targetfilter: 'Add/edit filter on destination',
            ...
            strings: {
                classshoulbeoriginordestination:
                    "The class '{0}' or a parent class of '{0}' must be set as `Origin` or `Destination`",
        ...
        gates: {
            ...
            importkeyattributes: 'Import key attributes',
            ...
            sourcelayertoexcludeempty:
                'Source cad layers to exclude from import. Enter the names of the layers separated by comma. (Ex. Layer1,Layer2,Layer3)',
            sourcelayertoinclude: 'Source layers to include',
            sourcelayertoincludeempty:
                'Source cad layers to import as shape file. Enter the names of the layers separated by comma. (Ex. Layer1,Layer2,Layer3)',
        ...
        groupandpermissions: {
            ...
            strings: {
                ...
                normal: 'Normal',
                readonlyadmin: 'Read-only admininistrator',
        ...
        home: {
            ...
            other: 'Other',
            parameter: 'Parameter',
            pluginexpirationcount: 'There are {0} plugins expiring:',
            pluginexpirationitem: 'Plugin <b>{0}</b> expires in <b>{1} days</b>',
            pluginexpirationitem_tomorrow: 'Plugin <b>{0}</b> expires tomorrow',
            pluginstatus: {
                description: 'Plugin',
        ...
        localizations: {
            ...
            lookup: 'Lookup',
            menuinfomessage:
                'Here are shown only folders and menu items with custom labels. Other menu items will take the original description.',
            menuitem: 'Menu item',
            odt: 'ODT',
            pdf: 'PDF',
            process: 'Process',
        ...
        plugin: {
            addplugin: 'Upload plugin',
            applied: 'Applied',
            appliedon: 'Applied on',
            applypatches: 'Apply patches',
            attentionrequired: 'At least one plugin is missing a patch',
            availablepatches: 'Plugins with patches available',
            emptyText: {
            ...
            modeldiff: {
                ...
                addedlookups: 'Added lookups',
                addedprocesses: 'Added processes',
                attributes: 'Attributes',
                changedattributes: 'Changed attributes',
                changedclasses: 'Changed classes',
                changeddomains: 'Changed domains',
                changedlookups: 'Changed lookups',
                changedprocesses: 'Changed processes',
                changedproperties: 'Changed properties',
                changedvalues: 'Changed values',
                classdata: 'Class data',
                domaindata: 'Domain data',
                downloadmodel: 'Download data model',
                emptydiff: 'Data model is already updated',
                infoeditdata:
                    'To import a JSON file containing changes to the data model, make sure you are in edit mode.',
                infomergedata: 'Merge started. You will be notified when it finishes',
                insertedattributes: 'Inserted attributes',
                insertedvalues: 'Inserted values',
                lookupdata: 'Lookup data',
                mergeconfirm:
                    'This action will affect the data model and cannot be undone. Are you sure you want to continue?',
                processdata: 'Process data',
                property: 'Property',
                reject: 'Reject',
                removedattributes: 'Removed attributes',
                removedclasses: 'Removed classes',
                removeddomains: 'Removed domains',
                removedlookups: 'Removed lookups',
                removedprocesses: 'Removed processes',
                removedvalues: 'Removed values',
                removeddmsmodels: 'Removed dms models',
                removeddmscategories: 'Removed dms categories',
                update: 'Update model',
                upload: 'Upload',
                values: 'Values'
            },
            ...
            patchesapplyfailed: 'Error on the patches application',
            patchesapplyfailedmessage: 'Errors occurred while applying some patches',
            plugin: 'Plugin',
        ...
        processes: {
            fieldlabels: {
                applicability: 'Applicability',
                enablesavebutton: 'Hide "Save" button',
                flowstatusattr: 'State attribute',
                messageattr: 'Message attribute',
                stoppablebyuser: 'Stoppable by User'
            },
            helps: {
                addhelp: 'Add help',
                defaultvalue: 'Default value',
                    ...
                    fieldsets: {
                        contextMenus: {
                            inputs: {
                                ...
                                javascriptScript: {
                                    label: 'Javascript script / custom GUI Parameters'
                                },
                                menuItemName: {
            ...
            texts: {
                activityattributenotfountinprocess:
                    'The attribute {0} is not fount in process attribute list. It will be ignored.',
                formclosedactivitymessage: 'Attention! Fields that are not in the layout will not be shown.',
                helpcantberemoved:
                    "This activity help can't be removed because is defined in XPDL file. Existing translations was deleted.",
                process: 'process',
        ...
        schedules: {
            ...
            fieldvalueunavailable:
                'The {0} field value has been removed because the previous value is no longer available.',
            frequency: 'Frequency',
        ...
        searchfilters: {
            ...
            texts: {
                ...
                grantpermissions:
                    'Following groups do not have read permission on this filter:{0} Do you want to grant it?',
        ...
        systemconfig: {
            ...
            allowonluthisfiletypesemptyvalue:
                'Enter extensions separated by comma. Eg pdf,odt,doc. Leave this field empty to disable extensions check.',
            allowonlythisfiletypesforcardandemail:
                'Allowed file extensions for attachments uploaded from the user interface',
            ...
            customercodehelp:
                'If it is not empty, the user will be shown the feature to automatically configure the mobile application.',
            ...
            imageresizemax: 'Image long side max size (px)',
            ...
            keepzoomandposition: 'Keep zoom and position',
            ldap: 'LDAP',
            ...
            maxdmsattachmentspreview:
                'Set the maximum number of attachments with preview (0 for no limits). Exceeding this limit will prevent attachments from being displayed with a preview to optimize performance.',
            ...
            mobile: 'Mobile',
            mobilenotificationauthinfo: 'Insert here the authentication JSON given by PAT',
            module: 'Module',
            monthsofinactivity: 'Months of inactivity',
            multitenantactivationmessage:
                'Changing these settings is irreversible, unless the database is restored. It is recommended to backup the database before proceeding.',
            multitenantapplychangerequest: 'Are you sure you want to continue?',
            multitenantinfomessage:
                'It is recommended to change these settings only after having consulted the guidelines present in the Administrator Manual, downloadable from {0}',
            multitenantlogoutmessage: 'After saving you will be logged out. Log in again to apply the changes.',
            ...
            onerror: 'On error',
            opendetailswindow: 'Open in details window',
            opensubclass: 'Open subclass',
            pagesize: 'Page Size',
            parameter: 'Parameter',
            password: 'Password',
            ...
            relationsnavigation: 'Relations navigation',
            request: 'Request',
        ...
        users: {
            ...
            messages: {
                ...
                ignoretenantswarningmsg:
                    'Warning! You have enabled one or more tenants. Some users might not be visible.',
                ignoretentnantsbtntext: 'Ignore tenants',
                passwordnotset:
                    'The password is not set, this user will not be able to log in to the system.</br>Are you sure?'
            },
            title: 'Users',
            toolbar: {
                addUserBtn: {
