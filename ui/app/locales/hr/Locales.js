(function () {
    Ext.define('CMDBuildUI.locales.hr.Locales', {
        ...
        arialabels: {
            buttonplaceholder: 'Tipka',
            iframeplaceholder: 'Uređivač teksta',
            languageselector: 'Odabir jezika',
            resizepanel: {
                horizontally: 'Promijeni veličinu panela horizontalno',
                vertically: 'Promijeni veličinu panela vertikalno'
            },
        ...
        calendar: {
            ...
            waiteventgeneration: 'Kreiranje događaja. Molim pričekajte do završetka',
        ...
        common: {
            actions: {
                ...
                close: 'Zatvori',
                copy: 'Kopiraj',
                copyerrormessage: 'Kopiraj pogrešku u međuspremnik',
                delete: 'Izbriši',
                edit: 'Uredi',
                execute: 'Izvrši',
                forward: 'Naprijed',
        ...
        dashboards: {
            tools: {
                ...
                downloaddata: 'Preuzmi podatke grafikona',
        ...
        errors: {
            ...
            nodatatoexport: 'Grafikon nema podataka za izvoz',
        ...
        gis: {
            ...
            code: 'Oznaka',
            contextmenu: {
                coordinates: 'Dohvati koordinate',
                coordinatescopiedmessage: 'Koordinate kopirane u međuspremnik'
            },
            description: 'Opis',
            extension: {
                errorCall: 'Greška',
        ...
        importexport: {
            ...
            gis: {
                importconfiguration: 'Uvezi konfiguraciju',
                shapeimportdisabled: 'Uvoz oblika za ovaj predložak nije omogućen',
                shapeimportenabled: 'Uvoz oblika za ovaj predložak je omogućen'
            },
            ifc: {
                card: 'Kartica',
                project: 'Projekt',
        ...
        joinviews: {
            ...
            selectdisplayattributegrid:
                'Molim odaberite bar jedan atribut za prikaz u rešetci i jedan u smanjenoj rešetci',
        ...
        main: {
            ...
            mobilediff: {
                acceptall: 'Prihvati sve promjene',
                acceptclass: 'Prihvati svih {0} promjena',
                acceptsingle: 'Prihvati promjenu',
                attribute: 'Atribut',
                changedcards: 'Promjenjeno kartica {0}',
                confirmedit: 'Mijenjate {0} kartica. Sigurno želite nastaviti?',
                createdcards: 'Kreirano kartica ({0})',
                current: 'Trenutna vrijednost',
                diffempty: 'Nema promjena za pregled',
                incoming: 'Nova vrijednost',
                popuptitle: 'Primjeni promjene za podatkovni skup {0}',
                rejectall: 'Odbaci sve promjene',
                rejectclass: 'Odbaci svih {0} promjena',
                rejectsingle: 'Odbaci promjenu',
                removedcards: 'Uklonjeno kartica ({0})'
            },
            ...
            preferences: {
                ...
                notificationssoundvolume: 'Glasnoća obavijesti',
                period: 'Razdoblje',
        ...
        notifier: {
            attention: 'Pažnja',
            copied: 'Kopirano',
            copied_to_the_clipboard: 'Tekst kopiran u međuspremnik',
            error: 'Greška',
            genericerror: 'Opća pogreška',
            genericerrormessage: 'Za više informacija, provjerite sistemse logove',
        ...
        relations: {
            ...
            cardnotpresentmessage:
                'Povezana kartica više nije dostupna. Nastavljanje sa izmjenama će zahtjevati odabir druge kartice.',
            code: 'Oznaka',
        ...
        reports: {
            ...
            msgs: {
                ...
                creationstarted:
                    'Započeto kreiranje izvještaja. Biti ćete obaviješteni kada bude spremno za preuzimanje.'
            },
            odt: 'ODT',
            pdf: 'PDF',
            print: 'Ispis',
        ...
        widgets: {
            attachment: {
                ...
                savebeforeexit:
                    'Postoje promjene na privitcima koji nisu spremljene. Želite li ih spremiti prije izlaza?',
                saveprocessmessage:
                    'Privitci mogu biti spremljeni samo u postojećim karticama. Pritiskom na spremi, instanca procesa će biti kreirana s podacima upisanim u obrazac.'
            },
            calendar: {
            ...
            notsupportedinline:
                'Inline način rada nije podržan za ovaj tip widgeta. Molim ispravite konfiguraciju widgeta.',
