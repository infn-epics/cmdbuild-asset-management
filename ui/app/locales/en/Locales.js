(function () {
    Ext.define('CMDBuildUI.locales.en.Locales', {
        ...
        arialabels: {
            ...
            iframeplaceholder: 'Text editor',
            languageselector: 'Language selector',
            resizepanel: {
                horizontally: 'Resize panels horizontally',
                vertically: 'Resize panels vertically'
            },
            usermenu: 'User menu'
        },
        attachments: {
            ...
            warningmessages: {
                atleast:
                    '{0}: {1} attachments of type "{2}" have been loaded. This category expects at least {3} attachments.',
                exactlynumber:
                    '{0}: {1} attachments of type "{2}" have been loaded. This category expects {3} attachments.',
                maxnumber:
                    '{0}: {1} attachments of type "{2}" have been loaded. This category expects at most {3}  attachments.'
            },
        ...
        bulkactions: {
            ...
            alertdownloadattachments:
                'Some attachments will not be downloaded because they have not yet been saved to the server',
            alertnoattachmentsdownload:
                'No attachments will be downloaded because they have not yet been saved to the server',
        ...
        calendar: {
            ...
            waiteventgeneration: 'Generating events. Please wait for them to complete',
        ...
        common: {
            actions: {
                ...
                close: 'Close',
                copy: 'Copy',
                copyerrormessage: 'Copy the error message to the clipboard',
                delete: 'Delete',
                edit: 'Edit',
                execute: 'Execute',
                forward: 'Forward',
        ...
        dashboards: {
            tools: {
                ...
                downloaddata: 'Download chart data',
        ...
        errors: {
            ...
            nodatatoexport: 'The chart has no data to export',
        ...
        gis: {
            ...
            contextmenu: {
                ...
                coordinatescopiedmessage: 'Coordinates copied to clipboard'
            },
            description: 'Description',
            extension: {
                errorCall: 'Error',
        ...
        importexport: {
            ...
            gis: {
                ...
                shapeimportenabled: 'The import of shapes is enabled for this template'
            },
            ifc: {
                card: 'Card',
                project: 'Project',
        ...
        joinviews: {
            ...
            selectdisplayattributegrid:
                'Please select at least one attribute to display in grid and one in reduced grid',
        ...
        main: {
            ...
            mobilediff: {
                ...
                confirmedit: 'You are modifying {0} cards. Are you sure that you want to proceed?',
                createdcards: 'Created cards ({0})',
                current: 'Current value',
                diffempty: 'There are no changes to evaluate',
                incoming: 'New value',
                popuptitle: 'Apply changes for dataset {0}',
            ...
            preferences: {
                ...
                notificationssoundvolume: 'Notification volume',
                period: 'Period',
        ...
        notifier: {
            attention: 'Attention',
            copied: 'Copied',
            copied_to_the_clipboard: 'Text copyed to the clipboard',
            error: 'Error',
            genericerror: 'Generic error',
            genericerrormessage: 'For more information, please check the system logs.',
        ...
        relations: {
            ...
            cardnotpresentmessage:
                'The related card is no longer available. Proceeding with the modification will require choosing another card.',
            code: 'Code',
            ...
            errorexisting:
                'Relation "{0}" already exists. Edit the existing one or delete it before create a new relation.',
        ...
        widgets: {
            attachment: {
                ...
                saveprocessmessage:
                    'Attachments can only be saved on existing cards. If you press save, the process instance will be created with the data you entered.'
            },
            calendar: {
            ...
            notsupportedinline:
                'Inline mode is not supported for this widget type. Please fix the widget configuration.',
