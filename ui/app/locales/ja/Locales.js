(function () {
    Ext.define('CMDBuildUI.locales.ja.Locales', {
        ...
        attachments: {
            ...
            warningmessages: {
                atleast:
                    '{0}: "{2}"タイプの{1}の添付ファイルがロードされました。このカテゴリは少なくとも {3} の添付ファイルを期待しています',
                exactlynumber:
                    '{0}: "{2}"タイプの{1}の添付ファイルがロードされました。このカテゴリは {3} の添付ファイルを期待しています',
                maxnumber:
                    '{0}: "{2}" タイプの {1} 添付ファイルがロードされました。このカテゴリは、最大でも {3} の添付ファイルを期待しています。'
            },
        ...
        bulkactions: {
            ...
            alertdownloadattachments:
                '一部の添付ファイルは、まだサーバーに保存されていないため、ダウンロードできません。',
        ...
        calendar: {
            ...
            type: 'タイプ',
            viewevent: 'スケジュール表示',
            waiteventgeneration: 'イベント作成中のためお待ちください',
            widgetcriterion: 'ルール',
            widgetemails: 'メール',
            widgetgotocard: '元カード',
        ...
        common: {
            actions: {
                ...
                close: '閉じる',
                copy: 'コピー',
                copyerrormessage: 'エラーメッセージをクリップボードにコピー',
                delete: '削除',
                edit: '編集',
                execute: '実行',
                forward: '転送',
        ...
        emails: {
            ...
            subject: '件名',
            templateattachments:
                'このメールには、テンプレートによって自動的にアップロードされた添付ファイルが含まれています',
            to: '宛先',
            view: 'ビュー'
        },
        errors: {
        ...
        gis: {
            ...
            contextmenu: {
                coordinates: '位置座標を取得',
                coordinatescopiedmessage: '位置座標がクリップボードにコピーされました'
            },
            description: '説明',
            extension: {
                errorCall: 'エラー',
        ...
        importexport: {
            ...
            gis: {
                importconfiguration: 'コンフィグレーションをインポート',
                shapeimportdisabled: 'このテンプレートは図形インポートできません',
                shapeimportenabled: 'このテンプレートでは図形のインポートが有効です'
            },
            ifc: {
                card: 'カード',
                project: 'プロジェクト',
        ...
        joinviews: {
            ...
            selectdisplayattributegrid:
                'グリッドに表示する属性と縮小グリッドに表示する属性を最低1つずつ選択してください',
            showingrid: 'グリッド表示',
        ...
        main: {
            ...
            mobilediff: {
                acceptall: '全ての変更を承認',
                acceptclass: '{0}の変更を承認',
                acceptsingle: '変更を承認',
                attribute: '属性',
                changedcards: '({0})カードを変更',
                confirmedit: '本当に{0}カードを変更してよろしいですか？',
                createdcards: '({0})カードが作成されました',
                current: '現在の値',
                diffempty: '評価すべき変更はありません',
                incoming: '新規値',
                popuptitle: '{0}データセットを適用',
                rejectall: '全ての変更を破棄',
                rejectclass: '{0}の変更を破棄',
                rejectsingle: '変更を破棄',
                removedcards: '({0})カードを削除'
            },
            multigroup: 'マルチグループ',
            multitenant: 'マルチ{0}',
            navigation: 'ナビゲーション',
        ...
        notifier: {
            ...
            error: 'エラー',
            genericerror: 'エラー',
            genericerrormessage: '詳細はシステムログを確認してください',
            genericinfo: '一般的情報',
        ...
        relations: {
            ...
            cardnotpresentmessage:
                '関連カードは使用できなくなりました。変更を続けるには、別のカードを選択する必要があります',
            code: 'コード',
            deletedetail: '詳細削除',
            ...
            errorexisting:
                'リレーション"{0}"はすでに存在します。新しいリレーションを作成する前に、既存のリレーションを編集するか、削除してください',
            extendeddata: '拡張データ',
            mditems: 'アイテム',
        ...
        widgets: {
            attachment: {
                ...
                saveprocessmessage:
                    '添付ファイルは既存のカードにしか保存できません。保存を押すと、フォームに入力されたデータでプロセスインスタンスが作成されます。'
            },
            calendar: {
            ...
            notsupportedinline:
                'このウィジェットタイプでは、インラインモードはサポートされていません。ウィジェットの設定を修正してください。',
