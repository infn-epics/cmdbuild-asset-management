(function () {
    Ext.define('CMDBuildUI.locales.sk.Locales', {
        ...
        arialabels: {
            buttonplaceholder: 'Tlačidlo',
            iframeplaceholder: 'Textový editor',
            languageselector: 'Výber jazyka',
            resizepanel: {
                horizontally: 'Zmeniť veľkosť panelov horizontálne',
                vertically: 'Zmeniť veľkosť panelov vertikálne'
            },
        ...
        calendar: {
            ...
            waiteventgeneration: 'Generujú sa udalosti. Počkajte, prosím, na ich dokončenie.',
        ...
        common: {
            actions: {
                ...
                close: 'Zavrieť',
                copy: 'Kopírovať',
                copyerrormessage: 'Skopírovať chybovú správu do schránky',
                delete: 'Zmazať',
                edit: 'Upraviť',
                execute: 'Vykonať',
                forward: 'Ďalej',
        ...
        dashboards: {
            tools: {
                ...
                downloaddata: 'Stiahnuť údaje grafu',
        ...
        errors: {
            ...
            nodatatoexport: 'Graf nemá žiadne údaje na export',
            notfound: 'Položka nebola nájdená'
        },
        filters: {
            actions: 'Akcie',
            addfilter: 'Pridať filter',
            any: 'Aspoň jeden / jedna',
            attachments: 'Prílohy',
        ...
        gis: {
            ...
            code: 'Kód',
            contextmenu: {
                coordinates: 'Získať súradnice',
                coordinatescopiedmessage: 'Súradnice skopírované do schránky'
            },
            description: 'Popis',
            extension: {
                errorCall: 'Chyba',
        ...
        importexport: {
            ...
            gis: {
                ...
                shapeimportenabled: 'Import tvarov je povolený pre túto šablónu'
            },
            ifc: {
                card: 'Karta',
                project: 'Projekt',
        ...
        joinviews: {
            ...
            selectdisplayattributegrid:
                'Vyberte prosím aspoň jeden atribút pre zobrazenie v mriežke a jeden v redukovanej tabuľke',
        ...
        main: {
            ...
            mobilediff: {
                ...
                acceptclass: 'Prijať všetky zmeny {0}',
                acceptsingle: 'Prijať zmenu',
                attribute: 'Atribút',
                changedcards: 'Zmenené karty ({0})',
                confirmedit: 'Meníte {0} kariet. Ste si istí, že chcete pokračovať?',
                createdcards: 'Vytvorené karty ({0})',
                current: 'Aktuálna hodnota',
                diffempty: 'Nie sú žiadne zmeny na vyhodnotenie',
                incoming: 'Nová hodnota',
                popuptitle: 'Aplikovať zmeny pre dataset {0}',
                rejectall: 'Zamietnuť všetky zmeny',
                rejectclass: 'Zamietnuť všetky zmeny {0}',
                rejectsingle: 'Zamietnuť zmenu',
                removedcards: 'Odstránené karty ({0})'
            },
            ...
            preferences: {
                ...
                notificationssoundvolume: 'Hlasitosť upozornení',
                period: 'Bodka',
        ...
        notifier: {
            ...
            copied: 'Skopírované',
            copied_to_the_clipboard: 'Text bol skopírovaný do schránky',
            error: 'Chyba',
            genericerror: 'Všeobecná chyba',
            genericerrormessage: 'Pre viac informácií si, prosím, pozrite systémové záznamy (logy).',
        ...
        relations: {
            ...
            cardnotpresentmessage:
                'Súvisiaca karta už nie je k dispozícii. Pokračovanie v úprave bude vyžadovať výber inej karty.',
            code: 'Kód',
            ...
            errorexisting:
                'Relácia "{0}" už existuje. Pred vytvorením novej relácie upravte existujúcu reláciu alebo ju odstráňte.',
        ...
        widgets: {
            attachment: {
                ...
                saveprocessmessage:
                    'Prílohy je možné ukladať iba na existujúce karty. Stlačením na uloženie, inštancia procesu sa vytvorí z údajov zadaných vo formulári.'
            },
            calendar: {
