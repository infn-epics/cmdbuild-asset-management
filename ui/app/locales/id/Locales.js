    ...
    Ext.define('CMDBuildUI.locales.id.Locales', {
        ...
        widgets: {
            attachment: {
                ...
                savebeforeexit:
                    'Ada perubahan yang belum disimpan di lampiran. Apakah Anda ingin menyimpannya sebelum keluar?',
                saveprocessmessage:
                    'Lampiran hanya dapat disimpan di kartu yang sudah ada. Menekan simpan contoh proses akan dibuat dengan data yang dimasukkan ke dalam formulir.'
            },
            calendar: {
