(function () {
    Ext.define('CMDBuildUI.locales.fa.Locales', {
        ...
        calendar: {
            ...
            cm_confirmcomplete:
                'آیا مطمئن هستید که می خواهید برنامه های انتخابی را به عنوان کامل شده علامت گذاری کنید؟',
        ...
        widgets: {
            attachment: {
                ...
                saveprocessmessage:
                    'پیوست ها را فقط می توان در کارت های موجود ذخیره کرد. با فشار دادن روی "ذخیره"، نمونه فرآیند با داده های وارد شده در فرم ایجاد می شود.'
            },
            calendar: {
