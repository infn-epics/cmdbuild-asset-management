...
Ext.define('Ext.locale.it.data.field.Field', {
    override: 'Ext.data.field.Field',
    defaultInvalidMessage: 'Questo campo è invalido'
});
...
Ext.define(
    ...
    { override: 'Ext.form.field.HtmlEditor', createLinkText: 'Inserire un URL per il link:' },
    function () {
...
Ext.define('Ext.locale.it.window.MessageBox', {
    ...
    titleText: { confirm: 'Conferma', prompt: 'Richiesta', wait: 'Attesa...', alert: 'Attenzione' }
});
