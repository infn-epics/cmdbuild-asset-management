...
Ext.define('Ext.locale.fr.tab.Tab', { override: 'Ext.tab.Tab', closeText: 'Fermer cet onglet' });
...
Ext.define(
    ...
    { override: 'Ext.form.field.HtmlEditor', createLinkText: "Veuillez entrer l'URL pour ce lien:" },
    function () {
