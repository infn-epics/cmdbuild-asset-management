Ext.define('CMDBuildUI.view.dashboards.ChartModel', {
    ...
    data: {
        ...
        paramsnames: {},
        toolsdisabled: false,
        storedata: { autoload: false, pagesize: 0, extraparams: {} },
        openinpopupbtn: { hidden: false },
        showhideparamsbtn: { hidden: true },
        showhidetablebtn: { hidden: true },
        downloaddatabtn: { hidden: true },
    ...
    formulas: {
        ...
        updateExtraParams: {
            bind: { bindTo: '{parameters}', deep: true },
            get: function (params) {
                var extraparams = {};
        ...
        applyFilterManager: {
            bind: { bindTo: { records: '{records}', filter: '{storedata.filter}' } },
            get: function (data) {
        ...
        downloadDataToolTip: {
            bind: '{chart}',
            get: function (chart) {
                return CMDBuildUI.locales.Locales.dashboards.tools.downloaddata;
            }
        },
    ...
    stores: {
        records: {
            type: '{storedata.type}',
            proxy: { type: 'baseproxy', url: '{storedata.proxyurl}', extraParams: '{storedata.extraparams}' },
