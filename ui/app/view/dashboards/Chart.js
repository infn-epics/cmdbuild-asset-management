Ext.define('CMDBuildUI.view.dashboards.Chart', {
    ...
    requires: ['CMDBuildUI.view.dashboards.ChartController', 'CMDBuildUI.view.dashboards.ChartModel'],

    alias: 'widget.dashboards-chart',
    controller: 'dashboards-chart',
    viewModel: { type: 'dashboards-chart' },
    ...
    tools: [
        {
            ...
            localized: { tooltip: 'CMDBuildUI.locales.Locales.dashboards.tools.openinpopup' },
            bind: { hidden: '{openinpopupbtn.hidden}', disabled: '{toolsdisabled}', userCls: 'management-tool' }
        },
        {
        ...
        {
            iconCls: CMDBuildUI.util.helper.IconHelper.getIconId('file-download', 'solid'),
            itemId: 'downloadDataBtn',
            enableToggle: true,
            hidden: true,
            bind: {
                hidden: '{downloaddatabtn.hidden}',
                disabled: '{toolsdisabled}',
                tooltip: '{downloadDataToolTip}',
                userCls: 'management-tool'
            }
        },
        {
            ...
            bind: { hidden: '{refreshbtn.hidden}', disabled: '{toolsdisabled}', userCls: 'management-tool' },
            localized: { tooltip: 'CMDBuildUI.locales.Locales.dashboards.tools.reload' }
        },
        {
            ...
            bind: { hidden: '{downloadbtn.hidden}', disabled: '{toolsdisabled}', userCls: 'management-tool' },
            localized: { tooltip: 'CMDBuildUI.locales.Locales.dashboards.tools.download' }
        }
    ]
});
