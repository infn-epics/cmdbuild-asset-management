Ext.define('CMDBuildUI.view.joinviews.configuration.items.ContextMenusFieldsetController', {
    ...
    /**
     *
     * @param {CMDBuildUI.view.joinviews.configuration.items.ContextMenusFieldset} view
     * @param {Object} eOpts
     */
    ...
    onAddNewContextMenuBtn: function (view, rowIndex, colIndex) {
        ...
        const contexstMenus = vm.get('theView.contextMenuItems');
        ...
        if (contexstMenus && contexstMenus.findRecord('label', newContextMenu.get('label'))) {
            view.down('#contextMenuLabel').markInvalid(
                CMDBuildUI.locales.Locales.administration.classes.properties.form.fieldsets.contextMenus.mustbeunique
            );
            return false;
        }
        Ext.suspendLayouts();
                ...
                items: [
                    {
                        ...
                        labelAlign: 'top',
                        fieldLabel:
                            CMDBuildUI.locales.Locales.administration.processes.properties.form.fieldsets.contextMenus
                                .inputs.typeOrGuiCustom.values.component.label,
                        localized: {
                            fieldLabel:
