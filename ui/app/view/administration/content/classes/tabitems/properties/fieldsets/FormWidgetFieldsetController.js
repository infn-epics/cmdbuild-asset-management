Ext.define(
    'CMDBuildUI.view.administration.content.classes.tabitems.properties.fieldsets.FormWidgetFieldsetController',
    {
        ...
        /**
         *
         * @param {CMDBuildUI.view.administration.content.classes.tabitems.properties.fieldsets.FormWidgetFieldset} view
         * @param {Object} eOpts
         */
        ...
        onAddNewWidgetMenuBtn: function (grid, rowIndex, colIndex) {
            ...
            const widgets = vm.get('theObject.widgets');
