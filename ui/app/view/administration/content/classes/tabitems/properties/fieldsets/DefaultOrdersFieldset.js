                            ...
                            columns: [
                                        ...
                                        if (record.get('attribute') === 'IdClass') {
                                            ...
                                            if (!value) {
                                                vm.bind(
                                                    ...
                                                    function (data) {
                                                        const _record = data.attributesStore.findRecord(
                                                            'name',
                                ...
                                },
                                {
                                    ...
                                    renderer: function (value) {
                                        const vm = this.lookupViewModel();
                                        const store = vm.get('defaultOrderDirectionsStore');
                                        if (store) {
                                            ...
                                            widget: {
                                                ...
                                                listeners: {
                                                    beforequery: function (queryEv) {
                                                        const allAttrStore =
                                                            this.lookupViewModel().get('theObject.defaultOrder');
                                                        if (this.getStore() && this.getStore()) {
                                                            ...
                                                            if (allAttrStore.getRange()) {
                                                                this.getStore().addFilter(function (item) {
                                                                    return !allAttrStore.findRecord(
                                                                        'attribute',
                                                                        item.get('name')
                                                                    );
                                                                });
                                            ...
                                            items: [
                                                ...
                                                },
                                                {
                                                    ...
                                                    isActionDisabled: function (
                                                        ...
                                                        return Ext.String.trim(record.get('attribute')).length
                                                            ? false
                                                            : true;
                                                    }
                                                }
