Ext.define(
    'CMDBuildUI.view.administration.content.dms.models.tabitems.properties.fieldsets.FormWidgetFieldsetController',
    {
        ...
        /**
         *
         * @param {CMDBuildUI.view.administration.content.dms.models.tabitems.properties.fieldsets.FormWidgetFieldset} view
         * @param {Object} eOpts
         */
        ...
        onAddNewWidgetMenuBtn: function (grid, rowIndex, colIndex) {
            ...
            const widgets = vm.get('theModel.widgets');
