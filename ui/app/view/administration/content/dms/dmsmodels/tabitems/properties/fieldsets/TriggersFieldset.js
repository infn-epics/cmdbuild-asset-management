                                            ...
                                            afterrender: function (cmp) {
                                                Ext.asap(function () {
                                                    ...
                                                    editor.getSession().on('change', function (event, _editor) {
                                                        ...
                                                        const rows = _editor.getScreenLength();
                                                        ...
                                                        const vm = me
                                                            .up(
                                                                'administration-content-dms-models-tabitems-properties-properties'
                                                            )
                                                            .lookupViewModel();
                                    ...
                                    widget: {
                                        ...
                                        listeners: {
                                            change: function (element, newValue, oldValue, eOpts) {
                                                element
                                                    .up(
                                                        'administration-content-dms-models-tabitems-properties-fieldsets-triggersfieldset'
                                                    )
                                                    .getViewModel()
