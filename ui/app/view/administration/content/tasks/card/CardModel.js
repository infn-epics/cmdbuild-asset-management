    ...
    formulas: {
        ...
        setupManager: function (data) {
            ...
            if (dmsEnabled) {
                ...
                this.set(
                    'defaultDMSCategoryType',
                    CMDBuildUI.util.helper.Configurations.get(CMDBuildUI.model.Configuration.dms.category)
                );
                this.set(
                    'dmsStoredata.url',
                    CMDBuildUI.util.administration.helper.ApiHelper.server.getAllDmsCategoriesValues()
                );
            ...
            this.set(
                'isGISEnabled',
                CMDBuildUI.util.helper.Configurations.get(CMDBuildUI.model.Configuration.gis.enabled)
            );
            this.set(
                'ifcAssociationModesData',
                CMDBuildUI.util.administration.helper.ModelHelper.ifcAssociationModes()
            );
        },
        ...
        allAttributesOfProcesManager: {
            ...
            get: function (data) {
                if (data.workflowClassName) {
                    ...
                    me.set(
                        'processAttachmentTypeLookup',
                        process.get('dmsCategory') ||
                            CMDBuildUI.util.helper.Configurations.get(CMDBuildUI.model.Configuration.dms.category)
                    );
        ...
        attributeKeyValueListManager: {
            ...
            get: function (data) {
                if (data.workflowClassName) {
                    var map =
                        typeof data.fieldsMappingsEmailService !== 'undefined'
                            ? data.fieldsMappingsEmailService
                            : data.fieldsMappingsWorkflow;
        ...
        processAttachmentTypeLookupManager: {
            ...
            get: function (data) {
                if (data.processAttachmentTypeLookup) {
                    this.set(
                        'processDmsStoredata.url',
                        CMDBuildUI.util.api.DMS.getCategoryValues(data.processAttachmentTypeLookup)
                    );
            ...
            get: function (data) {
                ...
                switch (data.type) {
                    case CMDBuildUI.model.tasks.Task.types.import_file:
                        ...
                        this.set('allImportExportTemplateFilter', [
                            function (item) {
                                return (
                                    item.get('type') === 'import' ||
                                    item.get('type') === CMDBuildUI.model.tasks.Task.types.import_export
                                );
                            }
                        ]);
            ...
            if (type) {
                types = Ext.Array.filter(types, function (item) {
                    if (
                        ...
                        type === CMDBuildUI.model.tasks.Task.types.export_file
                    ) {
            ...
            get: function (data) {
                ...
                if (data) {
                    ...
                    var title = Ext.String.format(
                        ...
                        data.totalStep,
                        isNaN(this.get('theTask._id'))
                            ? CMDBuildUI.locales.Locales.administration.dashboards['new']
                            : '',
                        typeLabel ? typeLabel : '',
            ...
            get: function (reportAttributesStore) {
                ...
                reportAttributesStore.each(function (attribute) {
                    var storeItem = {
                        ...
                        value:
                            currentParams && currentParams[attribute.get('name')]
                                ? currentParams[attribute.get('name')]
                                : null
                    };
            ...
            fields: [
                ...
                'description',
                {
                    ...
                    calculate: function (data) {
                        return data.description.length ? data.description : data.code;
                    }
                }
            ],
            proxy: {
    ...
    _allAttributeFilter: function () {
        ...
        return [
            function (item) {
                return (
                    item.canAdminShow() &&
                    !me.getStore('processAttributesMapStore').findRecord('key', item.get('name')) &&
        ...
        me.getFieldsAndLoadLookupValues(workflowClassName).then(function (fields) {
            if (!me.destroyed) {
                fields.forEach(function (field) {
                    field.hidden = false;
                    Ext.asap(
                        function (_field, _map, _processAttributesMapStore) {
                            if (!me.destroyed) {
                                        ...
                                        if (_field.name === keyValue[0]) {
                                            try {
                                                ...
                                                CMDBuildUI.util.Logger.log(
                                                    Ext.String.format('Process attribute {0} not found', keyValue[0]),
                        ...
                        me,
                        [field, map, processAttributesMapStore]
                    );
                });
