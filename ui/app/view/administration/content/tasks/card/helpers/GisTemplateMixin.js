Ext.define('CMDBuildUI.view.administration.content.tasks.card.helpers.GisTemplateMixin', {
    ...
    gistemplate: {
                ...
                ctx.getRowFieldContainer([
                    ...
                    ctx.getRowFieldContainer(
                        ...
                        ],
                        {
                            ...
                            listeners: {
                                hide: function (component, eOpts) {
                                    var postImportActionInput = component.down(
                                        '#gateconfig_handlers_0_postImportAction_input'
                                    );
                                    postImportActionInput.setValue('');
                                    CMDBuildUI.util.administration.helper.FieldsHelper.setAllowBlank(
                                        postImportActionInput,
                                        true,
                                        postImportActionInput.up('form')
                                    );
                                },
                                show: function (component, eOpts) {
                                    var postImportActionInput = component.down(
        ...
        getNotificationPanel: function (theVmObject, step, data, ctx) {
            var items = [
                ctx.getRowFieldContainer([ctx.getNotificationInput(theVmObject, 'config.notificationMode')]),
                ctx.getRowFieldContainer(
                    [
                        /*
