Ext.define(
    'CMDBuildUI.view.administration.content.processes.tabitems.properties.fieldsets.ContextMenusFieldsetController',
    {
        ...
        /**
         *
         * @param {CMDBuildUI.view.administration.content.processes.tabitems.properties.fieldsets.ContextMenusFieldset} view
         * @param {Object} eOpts
         */
        ...
        onAddNewContextMenuBtn: function (view, rowIndex, colIndex) {
            ...
            const contexstMenus = vm.get('theProcess.contextMenuItems');
