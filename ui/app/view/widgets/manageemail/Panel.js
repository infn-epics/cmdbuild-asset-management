...
Ext.define('CMDBuildUI.view.widgets.manageemail.Panel', {
    ...
    requires: ['CMDBuildUI.view.widgets.manageemail.PanelController'],
        ...
        afterTargetSave: function (target, widget, config) {
            ...
            if (!Ext.isEmpty(store.getNewRecords())) {
                ...
                function saveEmail(email) {
                    ...
                    // set the status
                    var status = target.get('_advance')
                        ? CMDBuildUI.model.emails.Email.statuses.outgoing
                        : CMDBuildUI.model.emails.Email.statuses.draft;
