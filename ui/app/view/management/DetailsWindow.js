(function () {
    ...
    Ext.define('CMDBuildUI.view.management.DetailsWindow', {
        ...
        id: elementId,
        autoEl: {
            'data-testid': 'management-detailsWindow'
        },
        ui: 'management',
        layout: 'fit',
        autoShow: true,
        ...
        initComponent: function () {
            var me = this;
            var width =
                CMDBuildUI.util.helper.Configurations.get(CMDBuildUI.model.Configuration.ui.detailwindow.width) + '%';
            var height =
                CMDBuildUI.util.helper.Configurations.get(CMDBuildUI.model.Configuration.ui.detailwindow.height) + '%';
            Ext.apply(this, {
                width: width,
                height: height,
                tools: []
