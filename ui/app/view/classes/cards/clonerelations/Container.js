                                    ...
                                    columns: [
                                        {
                                            ...
                                            listeners: {
                                                checkchange: function (column, rowindex, checked, record) {
                                                    if (checked && !record.get('ignore')) {
                                                        record.set('ignore', checked);
                                                        record.set('migrates', !checked);
                                                        record.set('clone', !checked);
                                                        record.set(
                                                            'mode',
                                                            CMDBuildUI.util.helper.FiltersHelper.cloneFilters.ignore
                                                        );
                                                    }
                                                }
                                            }
                                        },
                                        {
                                            ...
                                            listeners: {
                                                checkchange: function (column, rowindex, checked, record) {
                                                    if (checked && !record.get('migrates')) {
                                                        record.set('ignore', !checked);
                                                        record.set('migrates', checked);
                                                        record.set('clone', !checked);
                                                        record.set(
                                                            'mode',
                                                            CMDBuildUI.util.helper.FiltersHelper.cloneFilters.migrates
                                                        );
                                                    }
                                                }
                                            }
                                            ...
                                            renderer: function (value, cell, record) {
                                                ...
                                                if (Ext.isEmpty(value)) {
                                                    return Ext.String.format(
                                                        '<span class="x-grid-checkcolumn"></span>'
                                                    );
                                                }
                                                let klass = '';
                                                if (value) {
                                                ...
                                                return Ext.String.format(
                                                    '<span class="{0} x-grid-checkcolumn "></span>',
                                                    klass
                                                );
                                            },
                                            listeners: {
                                                ...
                                                checkchange: function (column, rowindex, checked, record) {
                                                    if (checked && !record.get('clone')) {
                                                        record.set('ignore', !checked);
                                                        record.set('migrates', checked);
                                                        record.set('clone', !checked);
                                                        record.set(
                                                            'mode',
                                                            CMDBuildUI.util.helper.FiltersHelper.cloneFilters.clone
                                                        );
                                                    }
                                                }
                                            }
