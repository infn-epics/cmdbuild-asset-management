Ext.define('CMDBuildUI.components.tab.BarWithTools', {
    ...
    addTool: function (tool) {
        ...
        me.on('afterrender', me.setupAriaAttributes, me, { single: true });
    },

    setupAriaAttributes: function () {
        const innerCt = this.layout && this.layout.innerCt && this.layout.innerCt.dom;
        if (innerCt) {
            innerCt.setAttribute('role', 'tablist');
        }
    },
